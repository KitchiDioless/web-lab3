import store from "/src/img/about/store.jpg";
import ceramic from "/src/img/about/ceramic.jpg";

class AboutPreviewSection extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <section class="promo__section-2">
                ...
                <div class="promo__section-2__articles">
                    ...
                    <h3 class="h3-default promo__section-2__article__title">our store</h3>
                        <div class="promo__section-2__article__content">
                            <div class="promo__section-2__article__img-container">
                                <img class="promo__section-2__article__img" src=${store} alt="Vases"/>
                            </div>
                    ...
                    <div class="promo__section-2__article">
                        ...
                        <div class="promo__section-2__article__img-container">
                            <img class="promo__section-2__article__img" src=${ceramic} alt="Ceramic"/>
                        </div>
                        <p class="promo__section-2__article__text">
...
customElements.define("about-preview-section", AboutPreviewSection);
