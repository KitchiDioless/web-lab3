...
import tea1 from "/src/img/works/ceramic-work-1.jpg";
import tea2 from "/src/img/works/ceramic-work-2.jpg";
import tea3 from "/src/img/works/ceramic-work-3.jpg";
import tea4 from "/src/img/works/ceramic-work-4.jpg";

class WorksGallerySection extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
    ...
    initSwiper() {
        const sliderElement = this.querySelector(".promo__section-4__slider");
        if (!sliderElement) return;
        
        new Swiper(sliderElement, this.getSwiperConfig());
    }
}

customElements.define("works-gallery-section", WorksGallerySection);
